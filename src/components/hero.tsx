export default function Hero() {
  return (
    <section className="md:relative w-full h-screen flex items-center justify-center bg-[url('../assets/about.jpg')] bg-blend-multiply bg-cover bg-center">
      <div className="md:absolute md:inset-0 md:z-10 md:bg-gradient-to-t from-black/100 to-transparent w-full mx-auto px-6 pt-30 md:pt-60 text-center">
